...
#   -> variable assignment (will probably need to `del`) all defined variables
#      at the end of an execution cycle
...
class ASTGenerator:
    ...
    def gen_expression_with_type(self, ty: Type):
        ...
        # the tree is.
        if random.random() < 0.5 and terminals:
    ...
    def gen_statement(self):
        possible_statements = [
            self.gen_method_statement,
            self.gen_if,
            self.gen_variable_assignment,
        ]
